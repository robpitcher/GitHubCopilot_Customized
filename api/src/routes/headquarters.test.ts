...
describe('Headquarters API', () => {
    ...
    it('should create a new headquarters', async () => {
        const newHeadquarters = {
            headquartersId: 2,
            name: "CatTech Regional HQ",
            description: "Regional headquarters for cat tech",
            address: "456 Feline Boulevard",
            contactPerson: "Robert Whiskers",
            email: "robert@octocat.com",
            phone: "555-0002"
        };
